const Home = () => {
  return (
    <section id="home">
      {/* Hero Section */}
      <div className="hero min-h-screen relative flex flex-col items-center justify-center text-white px-5 sm:px-10">
        <img
          src="/images/home-hero.jpg"
          alt="Ahuja's Production"
          className="absolute h-full w-full object-cover object-center -z-10"
        />
        <div className="absolute text-white/90 top-0 left-0 m-5 sm:m-10 text-[150px] font-bold">
          Ahuja's
        </div>
        <div className="absolute text-[#e29231cd] bottom-0 right-0 m-5 sm:m-10 text-[150px] font-bold">
          Production
        </div>
      </div>
      ...
      <div className="Modelling min-h-screen bg-[#D9D9D9] flex flex-col justify-center px-5 sm:px-10 gap-15 py-20 ">
        <h1 className="text-[#b67c35] text-9xl">Modelling</h1>
        <div className="flex flex-col gap-7 px-2">
          <p className=" text-5xl">What is Modelling?</p>
          <p className="text-4xl max-w-[90%] text-pretty">
      ...
      {/* Images Gallery */}
      <div className="flex min-h-screen items-center justify-center px-5 sm:px-10 gap-2 pt-50 pb-70 bg-black overflow-x-hidden">
        <img
          src="/images/home-gallery-1.jpg"
          alt=""
          className="max-w-[100px] lg:max-w-[300px] w-full object-cover object-center border-[10px] border-[#D9D9D9] translate-y-0"
        />
        <img
          src="/images/home-gallery-2.jpg"
          alt=""
          className="max-w-[300px] w-full object-cover object-center border-[10px] border-[#D9D9D9] -translate-x-6 translate-y-20 -rotate-12 z-10"
        />
        <img
          src="/images/home-gallery-3.jpg"
          alt=""
          className="max-w-[300px] w-full object-cover object-center border-[10px] border-[#D9D9D9] -translate-y-10"
        />
        <img
          src="/images/home-gallery-4.jpg"
          alt=""
          className="max-w-[300px] w-full object-cover object-center border-[10px] border-[#D9D9D9] translate-y-20"
        />
      </div>

      {/*Future Section */}
      <div className="Modelling min-h-screen flex justify-between px-5 sm:px-10 gap-15 py-30 ">
        <div className="h-full w-full flex flex-col justify-center gap-15   ">
          <h1 className="text-primary text-9xl">Future</h1>
          <div className="flex flex-col gap-7 px-2">
            <p className=" text-5xl">What is the Future of Modelling?</p>
            <p className="text-4xl w-full text-pretty">
        ...
        <img
          ...
          alt=""
          className="w-full max-w-1/3 h-full rounded-tr-full rounded-bl-full"
        />
      </div>

      {/* Bento Grid */}

      <div className="flex h-screen items-center justify-center px-5 sm:px-10 gap-2 my-20 bg-white py-10 relative">
        <div className="absolute font-semibold inset-0 flex items-center justify-center overflow-hidden">
          <div className="flex flex-col items-center justify-between leading-none max-w-[90%] h-full max-h-[85%] text-white/90 text-[120px] tracking-widest text-center">
      ...
      {/* Join Us Card */}
      <div className="flex justify-center items-center h-screen px-5 sm:px-10 my-50 py-10">
        <div className="flex gap-7 relative w-full h-full">
          <div className="flex flex-col gap-10 justify-center items-left w-full h-full z-10 text-white px-5 sm:px-10 py-10">
            <div className="flex flex-col gap-5">
              <div className="text-5xl font-bold">Become a Star</div>
              <div className="text-2xl font-semibold w-full max-w-1/2 text-white/90">
            ...
            <div className="bg-white text-black font-bold px-5 py-3 rounded-2xl max-w-[200px] text-center text-xl cursor-pointer">
              Join Us
            </div>
          </div>
